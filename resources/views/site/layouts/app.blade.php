...
<html lang="pt-br">
    <head>
        <title>{{$title or 'Agencia Turismo Demo'}}</title>
        <meta charset="UTF-8">
    ...
    <body>
        ...
        <nav class="navbar navbar-expand-lg navbar-light menu">
            <div class="container">
                ...
                <a class="navbar-brand" href="{{route('promotions')}}">
                    <img src="{{asset('assets/site/images/logo.png')}}" alt="" class="img-menu">
                </a>
                    ...
                    <div class="main-user-auth">
                        <div class="dropdown">
                            <a href="#" class="dropdown-toggle user-auth" id="dropdownMenuButton" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                <img src="{{asset('assets/site/images/no-image.png')}}" alt="" class="img-header-user">
                                Nome Usuário
                            </a>
